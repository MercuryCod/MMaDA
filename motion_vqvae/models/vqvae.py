...
from motion_vqvae.models.encdec import Encoder, Decoder
from motion_vqvae.models.quantize_cnn import QuantizeEMAReset, Quantizer, QuantizeEMA, QuantizeReset
...
class HumanVQVAE(nn.Module):
    def __init__(self,
        ...
        self.nb_joints = 21 if args.dataset.params.dataset_name == 'kit' else 22
